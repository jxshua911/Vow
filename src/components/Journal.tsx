...
export function JournalPage({ embedded = false }: { embedded?: boolean }) {
  ...
  if (loading) return <div>{!embedded && <PageHeader title="Journal" />}<div className="text-vow-muted text-sm">Loading your journal…</div></div>;
