...
const privacySections = [
  ...
  ['8. Security', 'VOW uses authentication controls, database access policies, server-side entitlement checks, input limits, AI usage controls and other technical safeguards. When a user creates an account, VOW can check the password against the Have I Been Pwned Pwned Passwords service using a privacy-preserving hash-prefix method; VOW does not send the password or its complete hash to that service. No internet service can guarantee absolute security.'],
