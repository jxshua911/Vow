      ...
      <div className="space-y-6">
        <div className="border border-vow-border p-5">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 border border-vow-border flex items-center justify-center"><User className="w-5 h-5 text-vow-ink" /></div>
        ...
        <div className="border border-vow-border p-5">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 border border-vow-border flex items-center justify-center shrink-0"><Bell className="w-5 h-5 text-vow-ink" /></div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2"><h2 className="text-sm font-medium text-vow-ink">Notifications</h2>{notificationsEnabled && <Check className="w-4 h-4 text-vow-ink" />}</div>
        ...
        <button onClick={handleSignOut} className="w-full flex items-center justify-center gap-2 border border-vow-border py-3 text-sm text-vow-muted hover:text-vow-ink hover:border-vow-ink transition-colors"><LogOut className="w-4 h-4" />Sign out</button>
      </div>
    </div>
  );
}
