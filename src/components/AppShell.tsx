...
export type View = 'dashboard' | 'calendar' | 'goals' | 'raven' | 'review' | 'profile' | 'legal';
...
const navItems: { view: Exclude<View, 'legal'>; label: string; icon: ReactNode }[] = [
  ...
  { view: 'raven', label: 'Raven', icon: <svg viewBox="0 0 24 24" fill="none" className="w-[21px] h-[21px]" aria-hidden="true"><path d="M5 5.5C8.8 4.2 13.7 4.5 17.5 7.2C19.2 8.4 20 10.1 20 12.2C20 15.8 17.2 18.5 13.5 18.5C10.8 18.5 8.9 17.1 7.5 15.3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><path d="M5 5.5L8.2 9.1L5.8 13.2L9.4 12.4L11.2 16.8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="15.8" cy="9.1" r="1" fill="currentColor"/></svg> },
