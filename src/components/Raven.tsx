  ...
  return <div>
    ...
    <section className="border border-vow-border p-6 mb-8">
      <div className="flex items-start justify-between gap-6">
        ...
        <div className="text-right"><p className="vow-label mb-2">Current streak</p><div className="flex items-center justify-end gap-2"><Flame className="w-5 h-5" /><span className="vow-heading text-3xl text-vow-ink">{snapshot.current_streak}</span><span className="text-xs text-vow-muted">days</span></div><p className="text-xs text-vow-muted mt-2">Best: {snapshot.best_streak} days</p></div>
      </div>
