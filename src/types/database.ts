...
export interface Goal { id: string; user_id: string; title: string; outcome: string; why_it_matters: string | null; start_date: string | null; duration: '1w' | '2w' | '3w' | '1m' | '2m' | '4w' | '8w' | '12w' | '26w' | null; deadline: string | null; status: GoalStatus; weekly_commitment_target: number; created_at: string; updated_at: string; }
