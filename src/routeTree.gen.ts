...
export interface FileRouteTypes {
  ...
  fullPaths:'/'|'/how-it-works'|'/copyright'|'/delete-account'|'/privacy'|'/privacy-policy'|'/support'|'/terms'
  fileRoutesByTo:FileRoutesByTo
  to:'/'|'/how-it-works'|'/copyright'|'/delete-account'|'/privacy'|'/privacy-policy'|'/support'|'/terms'
  id:'__root__'|'/'|'/how-it-works'|'/copyright'|'/delete-account'|'/privacy'|'/privacy-policy'|'/support'|'/terms'
